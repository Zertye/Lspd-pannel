...
// ============================================================================
// STATUTS DE PATROUILLE - AVEC CLASSES TAILWIND EXPLICITES
// ============================================================================
export const PATROL_STATUSES = [
  { 
    ...
    label: "Disponible", 
    color: "emerald",
    // Classes Tailwind explicites (PAS de construction dynamique)
...
// Helper pour obtenir un statut par ID
...
/**
 * Formate une durée en secondes en format lisible court
 * @param {number} seconds - Durée en secondes
 * @returns {string} - Format: "0m", "45m", "2h 30m"
 */
...
/**
 * Formate une durée en secondes en format lisible long
 * @param {number} seconds - Durée en secondes
 * @returns {string} - Format: "0 minutes", "45min", "2h 30min"
 */
 ...
 * @returns {boolean}
 */
export const isValidDiscord = (discord) => {
  if (!discord) return true; // Optionnel
  return /^.{2,32}#\d{4}$/.test(discord) || /^[a-z0-9_.]{2,32}$/.test(discord.toLowerCase());
};
...
// ============================================================================
// MAPPING DE COULEURS POUR BADGES ET VARIANTS
// ============================================================================
